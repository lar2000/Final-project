  ...
  return (function e(d) {
    ...
    function a(e, t, a) {
      if ("undefined" != typeof document) {
        "number" == typeof (a = s({ path: "/" }, r.defaults, a)).expires &&
    ...
    (r.Demo = {
      ...
      style: function (e, t) {
        ...
        return "all" === e
          ? a[t] || ""
          : "any" === e
          ? a.mode + " " + a.style + " " + a.aside + " " + a.header
          : "body" === e
          ? a.mode + " " + a.style
      ...
      apply: function () {
        ...
        for (var e = 0, t = i; e < t.length; e++) {
          ...
          ("aside" !== n && "header" !== n && "style" !== n) ||
            ((a = r.Demo.defs(n)),
            s((o = "aside" === n ? m : "header" === n ? c : d)).removeClass(
              r.Demo.style("all", n)
            ),
      ...
      update: function (e, t, a) {
        ...
        r.Demo.apps();
        ("aside" !== e && "header" !== e) ||
          (s((o = "header" == e ? c : m)).removeClass(i), s(o).addClass(n)),
          "mode" === e &&
      ...
      reset: function () {
        ...
        for (var e = 0, a = i; e < a.length; e++) {
          ...
          s("[data-key='" + o + "']").each(function () {
            ...
            ("aside" !== o && "header" !== o && "style" !== o) ||
              (e === y[t][o] && s(this).addClass("active")),
              ("mode" !== o && "skin" !== o) ||
                (e !== n && "default" !== e) ||
