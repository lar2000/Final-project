...
<link href="{{ url('assets/js/chunk-2d0c8403.5d43a989.js')}}" rel="prefetch">
<link href="{{ url('assets/js/chunk-2d0cfad0.ab3ad773.js')}}" rel="prefetch">
<link href="{{ url('assets/js/chunk-2d0d3a59.117500cd.js')}}" rel="prefetch">
<link href="{{ url('assets/js/chunk-2d0e1d50.61a65b7e.js')}}" rel="prefetch">
<link href="{{ url('assets/js/app.3f7188c4.js')}}" rel="preload" as="script">
<link href="{{ url('assets/js/chunk-vendors.1497b8a5.js')}}" rel="preload" as="script">
...
<script src="{{ url('assets//js/bundle.js?ver=3.2.3')}}"></script>
...
<script src="{{ url('assets//js/chunk-vendors.1497b8a5.js')}}"></script>
<script src="{{ url('assets//js/app.3f7188c4.js')}}"></script>
<script src="{{ url('assets//js/app.3f7188c4.js')}}"></script>
