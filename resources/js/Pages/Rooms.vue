                            ...
                            <div class="drodown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <ul class="link-list-opt no-bdr">
                                  <li>
                                    <a data-bs-toggle="modal" href="#add-room"
                                      ><span>Add Room</span></a
                                    >
                                  </li>
                                  <li>
                                    <a href="#"><span>Import Room</span></a>
                                  </li>
                                </ul>
                              </div>
                            </div>
                        ...
                        <div class="card-inner p-0">
                          <div class="nk-tb-list nk-tb-ulist">
                            <div class="nk-tb-item nk-tb-head">
                              ...
                              <div class="nk-tb-col">
                                <span class="sub-text">Room No.</span>
                              </div>
                              <div class="nk-tb-col">
                                <span class="sub-text">Room Type</span>
                              </div>
                              <div class="nk-tb-col tb-col-md">
                                <span class="sub-text">AC/Non AC</span>
                              </div>
                              <div class="nk-tb-col tb-col-lg">
                                <span class="sub-text">Meal</span>
                              </div>
                              <div class="nk-tb-col tb-col-lg">
                                <span class="sub-text">Bed Capacity</span>
                              </div>
                              <div class="nk-tb-col tb-col-mb">
                                <span class="sub-text">Rent</span>
                              </div>
                              <div class="nk-tb-col tb-col-md">
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col">
                                <span
                                  >Single
                                  <span
                                    class="dot dot-primary d-md-none ms-1"
                                  ></span
                                ></span>
                              </div>
                              <div class="nk-tb-col tb-col-md">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-amount"
                                  >32.00 <span class="currency">USD</span></span
                                >
                              </div>
                              <div class="nk-tb-col tb-col-md">
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col">
                                <span
                                  >Single
                                  <span
                                    class="dot dot-warning d-md-none ms-1"
                                  ></span
                                ></span>
                              </div>
                              <div class="nk-tb-col tb-col-md">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-amount"
                                  >35.00 <span class="currency">USD</span></span
                                >
                              </div>
                              <div class="nk-tb-col tb-col-md">
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-amount"
                                  >44.99 <span class="currency">USD</span></span
                                >
                              </div>
                              <div class="nk-tb-col tb-col-md">
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-amount"
                                  >48.99<span class="currency">USD</span></span
                                >
                              </div>
                              <div class="nk-tb-col tb-col-md">
                                <span class="tb-status text-success">Open</span>
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-amount"
                                  >53.99<span class="currency">USD</span></span
                                >
                              </div>
                              <div class="nk-tb-col tb-col-md">
                                <span class="tb-status text-primary"
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-amount"
                                  >68.99<span class="currency">USD</span></span
                                >
                              </div>
                              <div class="nk-tb-col tb-col-md">
                                <span class="tb-status text-primary"
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col">
                                <span
                                  >Suit<span
                                    class="dot dot-danger d-md-none ms-1"
                                  ></span
                                ></span>
                              </div>
                              <div class="nk-tb-col tb-col-md">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-amount"
                                  >450<span class="currency">USD</span></span
                                >
                              </div>
                              <div class="nk-tb-col tb-col-md">
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-amount"
                                  >499.99<span class="currency">USD</span></span
                                >
                              </div>
                              <div class="nk-tb-col tb-col-md">
                                <span class="tb-status text-danger"
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-amount"
                                  >999.99<span class="currency">USD</span></span
                                >
                              </div>
                              <div class="nk-tb-col tb-col-md">
                                <span class="tb-status text-danger"
