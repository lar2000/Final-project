<template>
              ...
              <div class="nk-block-head nk-block-head-sm" v-if="!showForm">
                <div class="nk-block-between">
                  <div class="nk-block-head-content">
                    <h6 class="nk-block-title page-title">ລາຍການປະຫວັດການຊຳລະ</h6>
                  </div>
                  <div class="nk-block-head-content">
  ...
  ,
      ...
      async updatePayment() {
    try {
      // Use the correct endpoint URL and ensure `pay_id` is used
  ...
  async deletePayment(id) {
    if (confirm('Are you sure you want to delete this payment?')) {
      try {
        // Ensure `pay_id` is used and the URL matches the route
