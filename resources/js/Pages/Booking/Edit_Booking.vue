                                            ...
                                            <div class="row gy-4">
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label"
                                                            ...
                                                            placeholder="First Name" value="Abu Bin"></div>
                                                </div>
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label"
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label"
                                                            ...
                                                            value="102 Cherry Ridge Drive, Detroit"></div>
                                                </div>
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label">Select an
                                                        ...
                                                        <div class="form-control-wrap"><select
                                                                ...
                                                                <option value="option_select_name">Honeymoon Package
                                                                </option>
                                                                <option value="option_select_name">Vacation Package
                                                                </option>
                                                                <option value="option_select_name">Spring Package
                                                                </option>
                                                            </select></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-4 col-xxl-3">
                                                    <div class="form-group"><label class="form-label"
                                                            ...
                                                            placeholder="Total Person" value="02"></div>
                                                </div>
                                                <div class="col-md-12">
