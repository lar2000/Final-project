                            ...
                            <ul class="nk-block-tools g-3">
                              <li>
                                <button
                                  ...
                                  ><span>ແກ້ໄຂ</span></button
                                >
                              </li>
                              <li class="nk-block-tools-opt">
                                <div class="drodown">
                                  <button
                                    class="dropdown-toggle btn btn-icon btn-info"
                                    data-bs-toggle="dropdown">ເພີ່ມ</button>
                                    ...
                                    <ul class="link-list-opt no-bdr">
                                      <li>
                                        <router-link
                                          ...
                                          to="/Customers_add"
                                          ><span>Add Customer</span></router-link>
                                      </li>
                                      <li>
                                        <a href="#"
                          ...
                          <div class="nk-tb-list nk-tb-ulist">
                            <div class="nk-tb-item nk-tb-head">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="sub-text">Last Package</span>
                              </div>
                              ...
                              <div class="nk-tb-col tb-col-lg">
                                <span class="sub-text">Last Check Out</span>
                              </div>
                              <div class="nk-tb-col tb-col-mb">
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col tb-col-lg">
                                <ul class="list-status">
                                  <li>
                                    <em
                                      class="icon text-success ni ni-check-circle"
                                    ></em>
                                    <span>Email</span>
                                  </li>
                                </ul>
                            ...
                            <div class="nk-tb-item">
                              ...
                              <div class="nk-tb-col tb-col-mb">
                                <span class="tb-status text-orange"
                                  >Platinum</span
                                >
                              </div>
                              <div class="nk-tb-col nk-tb-col-tools">
