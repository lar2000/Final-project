                      ...
                      <ul class="nk-block-tools g-3">
                        <li>
                          <button href="#" class="btn btn-warning">
                            <em class="icon ni ni-download-cloud"></em><span>ແກ້ໄຂ</span>
                          </button>
                        </li>
                          ...
                          <div class="drodown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                              <ul class="link-list-opt no-bdr">
                                <li>
                                  <router-link data-bs-toggle="modal" to="/Customers_add"
                                    ><span>Add Customer</span></router-link
                                  >
                                </li>
                                <li>
                                  <a href="#"><span>Import Customer</span></a>
                                </li>
                              </ul>
                            </div>
                          </div>
                                ...
                                <li>
                                  ...
                                  >
                                    <input
                                      ...
                                      checked=""
                                      id="gp"
                                    /><label class="custom-control-label" for="gp"
                                      >Group</label
                                    >
                                  </div>
                                </li>
                            ...
                            <li>
                              <div class="drodown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                  <ul class="link-list-opt no-bdr">
                                    <li>
                                      <a href="#"><em class="icon ni ni-activity-round"></em
